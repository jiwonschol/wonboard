...
export default defineConfig({
  ...
  outputDir: "./test-results/sites", reporter: "list",
  use: { baseURL: "http://127.0.0.1:5174", locale: "en-US", screenshot: "only-on-failure" },
  webServer: { command: "node node_modules/vite/bin/vite.js --config vite.sites-test.config.ts --mode sites-test --host 127.0.0.1 --port 5174 --strictPort",
